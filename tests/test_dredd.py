...
class DreddTest(TestCase):
    def test_mark_unhealthy_as_suspicious(self):
        instances = [Instance("abc", "name", "dns", "asg", "healthy"),
                     Instance("xyz", "name", "dns", "asg", "unhealthy"),
                     Instance("def", "name", "dns", "asg", "healthy")]
    ...
    def test_remove_healthy_from_suspects(self):
        ...
        instances_1 = [Instance("abc", "name", "dns", "asg", "healthy"),
                       Instance("xyz", "name", "dns", "asg", "unhealthy"),
                       Instance("def", "name", "dns", "asg", "healthy")]

        dredd.patrol(instances_1)

        instances_2 = [Instance("abc", "name", "dns", "asg", "healthy"),
                       Instance("xyz", "name", "dns", "asg", "healthy"),
                       Instance("def", "name", "dns", "asg", "healthy")]
    ...
    def test_count_suspects_failures(self):
        ...
        instances = [Instance("abc", "name", "dns", "asg", "healthy"),
                     Instance("xyz", "name", "dns", "asg", "unhealthy"),
                     Instance("opq", "name", "dns", "asg", "unhealthy"),
                     Instance("def", "name", "dns", "asg", "healthy")]
    ...
    def test_punish_suspects_with_too_many_failures(self):
        ...
        instances_2 = [Instance("abc", "name", "dns", "asg", "healthy"),
                       Instance("xyz", "name", "dns", "asg", "unhealthy"),
                       Instance("opq", "name", "dns", "asg", "healthy"),
                       Instance("def", "name", "dns", "asg", "healthy")]
