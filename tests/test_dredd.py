...
class DreddTest(TestCase):
    def test_mark_unhealthy_as_suspicious(self):
        instances = [Instance("abc", "name", "address", "asg", Instance.STATUS_UP),
                     Instance("xyz", "name", "address", "asg", Instance.STATUS_DOWN),
                     Instance("def", "name", "address", "asg", Instance.STATUS_UP)]
    ...
    def test_remove_healthy_from_suspects(self):
        ...
        instances_1 = [Instance("abc", "name", "address", "asg", Instance.STATUS_UP),
                       Instance("xyz", "name", "address", "asg", Instance.STATUS_DOWN),
                       Instance("def", "name", "address", "asg", Instance.STATUS_UP)]

        dredd.patrol(instances_1)

        instances_2 = [Instance("abc", "name", "address", "asg", Instance.STATUS_UP),
                       Instance("xyz", "name", "address", "asg", Instance.STATUS_UP),
                       Instance("def", "name", "address", "asg", Instance.STATUS_UP)]
    ...
    def test_count_suspects_failures(self):
        ...
        instances = [Instance("abc", "name", "address", "asg", Instance.STATUS_UP),
                     Instance("xyz", "name", "address", "asg", Instance.STATUS_DOWN),
                     Instance("opq", "name", "address", "asg", Instance.STATUS_DOWN),
                     Instance("def", "name", "address", "asg", Instance.STATUS_UP)]
    ...
    def test_punish_suspects_with_too_many_failures(self):
        ...
        instances_2 = [Instance("abc", "name", "address", "asg", Instance.STATUS_UP),
                       Instance("xyz", "name", "address", "asg", Instance.STATUS_DOWN),
                       Instance("opq", "name", "address", "asg", Instance.STATUS_UP),
                       Instance("def", "name", "address", "asg", Instance.STATUS_UP)]
